      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 bg-w  ">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl border-t mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Espace Annonces</h2>
            <p className="text-xl text-gray-400">Retrouver toute les annnonces lies au changement et au concours de la zone CEMAC et autres</p>
          </div>
